  ...
  if (projects.length === 0) {
    return (
      <div className="text-center py-16 px-6 bg-white dark:bg-slate-800/50 rounded-xl shadow-sm">
        ...
        <h3 className="mt-4 text-xl font-semibold text-slate-900 dark:text-white font-display">មិនមានគម្រោងនោះទេ</h3>
        <p className="mt-2 text-base text-slate-500 dark:text-slate-400">សូមព្យាយាមកំណត់ការស្វែងរក ឬបន្ថែមគម្រោងថ្មី។</p>
      </div>
    );
  }
